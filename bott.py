...
def check_phone(phone):
    ...
    if is_obviously_fake(phone):
        return (f"📱 *ПРОВЕРКА ТЕЛЕФОНА*\n━━━━━━━━━━━━━━━━━━━━━━\n❌ *Статус:* НЕ ВАЛИДНЫЙ\n📞 *Номер:* {phone}\n💡 *Причина:* Повторяющиеся цифры или тестовый номер\n━━━━━━━━━━━━━━━━━━━━━━")
    if len(clean) < 10 or len(clean) > 15:
        return (f"📱 *ПРОВЕРКА ТЕЛЕФОНА*\n━━━━━━━━━━━━━━━━━━━━━━\n❌ *Статус:* НЕ ВАЛИДНЫЙ\n📞 *Номер:* {phone}\n💡 *Причина:* Длина {len(clean)} (нужно 10-15)\n━━━━━━━━━━━━━━━━━━━━━━")
    ...
    try:
        ...
        if data.get('is_valid_number', False):
            ...
            return (f"📱 *ПРОВЕРКА ТЕЛЕФОНА*\n━━━━━━━━━━━━━━━━━━━━━━\n{status_text}\n📞 *Номер:* {data.get('phone_number', formatted)}\n🌍 *Страна:* {data.get('country_code', country)}\n📡 *Оператор:* {carrier}\n🔢 *Тип:* {line_type}\n━━━━━━━━━━━━━━━━━━━━━━\n🔄 *Источник:* omkar.cloud\n🕒 {datetime.now().strftime('%d.%m.%Y %H:%M:%S')}")
        else:
    ...
    return (f"📱 *ПРОВЕРКА ТЕЛЕФОНА*\n━━━━━━━━━━━━━━━━━━━━━━\n⚠️ *Статус:* НЕ ОПРЕДЕЛЁН (API недоступен)\n📞 *Номер:* {formatted}\n🌍 *Страна:* {country}\n🔢 *Тип:* {type_hint}\n💡 *Проверьте номер вручную*\n━━━━━━━━━━━━━━━━━━━━━━\n🔄 *Источник:* Локальная проверка\n🕒 {datetime.now().strftime('%d.%m.%Y %H:%M:%S')}")
...
def check_email(email):
    ...
    if domain in fake_domains:
        return (f"📧 *ПРОВЕРКА EMAIL*\n━━━━━━━━━━━━━━━━━━━━━━\n⚠️ *Статус:* ФЕЙКОВЫЙ\n📧 *Email:* {email}\n📮 *Домен:* {domain}\n💡 *Причина:* Домен для временной почты\n━━━━━━━━━━━━━━━━━━━━━━")
    try:
        import socket
...
def check_card(card):
    ...
    if not clean.isdigit():
        return (f"💳 *ПРОВЕРКА КАРТЫ*\n━━━━━━━━━━━━━━━━━━━━━━\n❌ *Статус:* НЕВАЛИДНАЯ\n💡 *Причина:* Только цифры\n━━━━━━━━━━━━━━━━━━━━━━")
    if len(clean) not in [15, 16]:
        return (f"💳 *ПРОВЕРКА КАРТЫ*\n━━━━━━━━━━━━━━━━━━━━━━\n❌ *Статус:* НЕВАЛИДНАЯ\n💡 *Причина:* Длина {len(clean)} (нужно 15 или 16)\n━━━━━━━━━━━━━━━━━━━━━━")
    def luhn(n):
        s = 0
    ...
    try:
        ...
        pass
    return (f"💳 *ПРОВЕРКА КАРТЫ*\n━━━━━━━━━━━━━━━━━━━━━━\n✅ *Статус:* ВАЛИДНАЯ\n💳 *Система:* {system}\n🔢 *Номер:* {clean[:4]}****{clean[-4:]}{bank_info}\n━━━━━━━━━━━━━━━━━━━━━━\n🕒 {datetime.now().strftime('%d.%m.%Y %H:%M:%S')}")
